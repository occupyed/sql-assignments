...
-- The above query selects only one person with the second-highest salary. 
-- But what if there are more than 1 person with the same salary? Or, 
-- what if we want to select the 3rd or 4th highest salary? So, let’s try a generic approach.
